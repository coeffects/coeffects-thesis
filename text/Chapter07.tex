...
Section~\ref{sec:flat-unique}), we generate additional coeffect constraints for each lambda abstraction
...
per-variable and so the resulting type reflects the fact that only the variable \ident{y} appears
inside \kvd{prev}.
...
The idea of active reading is older and has been encouraged in the context of art in Josef Albers'
...
The implementation discussed in this chapter provides evidence for our claim that the
