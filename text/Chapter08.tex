...
Section~\ref{sec:further-types}, we need to modify the domains and codomains of the \ident{merge},
...
and Lemma~\ref{thm:further-rev-exch} relied on sub-coeffecting in the flat system.
