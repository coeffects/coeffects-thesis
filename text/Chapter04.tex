...
The (\emph{internalized substitution}) rule models an operational semantics where the language
provides a construct that models \emph{sequential composition} and expressions can be reduced to 
...
\begin{equation*}
\tyrule{sub}
 { \coctx{\Gamma, x:\tau_1}{\cclrd{r}\;\czip\;\cclrd{t}} \vdash \subst{e}{x}{v} : \tau_2 }
 { \coctx{\Gamma, x:\tau_1}{\cclrd{r}\;\cpar\;\cclrd{t}} \vdash \subst{e}{x}{v} : \tau_2 } 
\end{equation*}
%
...
ALSO: Something on eta expansion
