...
\end{align*}
%
The symmetry of $\cseq$ holds for all our examples, but we do not include it so that we do not
...
The type system is more restrictive than the fully general one and it rejects certain programs that
