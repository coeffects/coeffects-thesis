...
the calculus are those of the $\lambda$-calculus wwith \emph{let} binding; assuming $\alpha$ ranges 
...
if $\ctx{\Gamma}{\cclrd{r}} \vdash e : \tau$ 
...
\begin{array}{lll}
 ...
 \mtyp{\cclrd{r}}\tau = (\cclrd{r} \rightarrow \sigma) \rightarrow \tau && (\emph{eader monad})
\end{array} 
\end{equation*}
%
