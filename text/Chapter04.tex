...
Most of the related work has been already discussed in Chapter~\ref{ch:pathways} or throughout
the chapter. In this section, we look in more details at the relationship between coeffects,
comonads and monads.

\subsection{When coeffect is not a monad}
...
\subsection{When coeffect is a monad}
As discussed in \ref{sec:applications-flat-impl} ...

Product comonad

$C_{\cclrd{r}}\tau = \tau \times (\cclrd{r} \rightarrow \sigma)$

Reader monad

$M_{\cclrd{r}}\tau = (\cclrd{r} \rightarrow \sigma) \rightarrow \tau$
...
\begin{equation*}
(\tau_1 \rightarrow \mtyp{\cclrd{r} \cseq \cclrd{s}}{\tau_2}) \rightarrow 
  \mtyp{\cclrd{r}}{(\tau_1 \rightarrow \mtyp{\cclrd{s}}{\tau_2})}
\end{equation*}
