...
and whole-context dataflow (Section~\ref{sec:applications-flat-dataflow}) have a very similar 
...
requirements using $\cclrd{r} \cup \cclrd{s}$, but for dataflow and liveness it suffices to 
