...
The key claim of this thesis is that the theory of \emph{coeffects} that we develop provides
a unified way of capturing how programs rely on the context, or execution environment, 
in which they execute. Perhaps most importantly, coeffects provide a single conceptual framework 
that can capture a wide range of previously disconnected notions of context-awareness. 
