...
\vspace{0.25em}\noindent\hangindent=0.6cm 
Case (\emph{num}): After applying $\ident{split}_{\cclrd{r}, \cclrd{s}\cseq\cclrd{t}}$, the types of 
...
$\ident{Df}\langle\ldots\rangle$ and $\ident{prev}_{\cclrd{n}}$. Then 
we extend the type preservation (Theorem~\ref{thm:semantics-fp-pres}) and progress
(Theorem~\ref{thm:semantics-fp-prog}).
