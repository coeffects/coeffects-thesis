...
\ctparttext{This part presents the key novel contributions of the thesis. We develop \emph{flat}
  and \emph{structural} coeffect calculi that capture a wide range of context-aware programming
  languages discussed in the previous section. We present parameterized coeffect type system, 
  categorical model based on indexed comonads. We use the model to give semantics in terms of 
  translation to a target functional language and we present syntactic safety proof for 
  context-aware languages with implicit parameters and dataflow.}
\setcounter{part}{1}
